...
namespace RouteService.Cache
{
    ...
    public class MemoryCache<TKey, TValue>
    {
        ...
        public MemoryCache(TimeSpan expirationTime) : this (expirationTime, new MemoryCache(new MemoryCacheOptions()))
        {
        }

        public MemoryCache(TimeSpan expirationTime, IMemoryCache memoryCache)
        {
